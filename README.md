...
<img src="logos/logo.svg" alt="CityBridge Logo" width="300"/>
...
- Log out securely
- Request a permit
- Modify permit requests before approval
- Renew approved permits
- View all submitted permits
- Filter permits by status (Pending, Approved, Rejected)
- View permit details
...
- Log in securely
- Log out securely
- View all permit requests
- Approve permit requests
